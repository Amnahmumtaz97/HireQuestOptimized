        ...
        {pageItems.map((stage, index) => {
          ...
          return (
            <li key={stage.id} className="relative flex gap-4 pb-5 last:pb-0">
              {!isLast ? (
                <span
                  className="absolute left-[17px] top-10 h-[calc(100%-1.25rem)] w-px bg-border"
                  aria-hidden
                />
              ) : null}
              ...
              <button
                ...
                className={[
                  'relative z-[1] flex h-9 w-9 shrink-0 items-center justify-center rounded-full border text-xs font-bold transition',
                  completed
