    ...
    return (
      <input
        ...
        className={[
          ...
          'focus-visible:outline-none focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-[color-mix(in_oklab,var(--primary)_25%,transparent)] focus-visible:shadow-glow-sm',
